...
#[Route('/agent/inscription')]
class AgentInscriptionController extends AbstractController
{
    // Liste toutes les inscriptions
    #[Route('/', name: 'agent_inscription_index', methods: ['GET'])]
    public function index(InscriptionRepository $inscriptionRepository): Response
    {
        return $this->render('inscription/indexAgent.html.twig', [
            'inscriptions' => $inscriptionRepository->findAll(),
        ]);
    }

    // Crée une nouvelle inscription
    #[Route('/new', name: 'agent_inscription_new', methods: ['GET', 'POST'])]
       ...
       $inscription = new Inscription();
        ...
        if ($request->isMethod('POST')) {
            ...
            if (!$event) {
                ...
                return $this->redirectToRoute('agent_inscription_new');
            }
            ...
            return $this->redirectToRoute('agent_inscription_index');
        }

        // Pass events to the template for both initial load and form errors
        return $this->render('inscription/newAgent.html.twig' , [
            'events' => $events,
        ]);
    }

    // Affiche les détails d'une inscription
    #[Route('/{id}', name: 'agent_inscription_show', methods: ['GET'])]
    public function show(Inscription $inscription): Response
    {
        return $this->render('inscription/showAgent.html.twig', [
            'inscription' => $inscription,
        ]);
    }

    // Modifie une inscription existante
    #[Route('/{id}/edit', name: 'agent_inscription_edit', methods: ['GET', 'POST'])]
    ...
    if ($request->isMethod('POST')) {
        ...
        if (!$newEvent) {
            ...
            return $this->redirectToRoute('agent_inscription_edit', ['id' => $inscription->getId()]);
        }
    ...
    return $this->render('inscription/editAgent.html.twig', [
        'inscription' => $inscription,
    ...
    #[Route('/{id}', name: 'agent_inscription_delete', methods: ['POST'])]
