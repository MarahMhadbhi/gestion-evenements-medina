...
#[Route('responsable/event')]
class ResponsableEventController extends AbstractController

{
    #[Route('/', name: 'app_respo_event_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'responsable_event_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($logoFile) {
                ...
                $sponsorLogosFiles = $request->files->get('sponsorFiles');
            ...
            return $this->redirectToRoute('app_respo_event_index', [], Response::HTTP_SEE_OTHER);
        }
        return $this->render('event/newResponsable.html.twig', [
            'event' => $event,
   ...
   #[Route('/{id}/edit', name: 'responsable_event_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Event $event, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
        ...
        return $this->render('event/editResponsable.html.twig', [
            'event' => $event,
            'form' => $form->createView(),
    ...
    #[Route('/{id}', name: 'responsable_event_delete', methods: ['POST'])]
